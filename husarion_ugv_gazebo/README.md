...
- `strip_base_color` [*string*, default: **"1 1 1"**]: RGB diffuser color that unlit LEDs are blended toward by brightness, so the strip looks like a lit white diffuser instead of going black where the animation is dark.
