...
Required parameters are defined when including the interface in the URDF (you can check out [panther_macro.urdf.xacro](../husarion_ugv_descriptions/urdf/panther_macro.urdf.xacro)).
...
The following parameters are required when including this interface in the URDF (you can refer to the [gazebo.urdf.xacro](../husarion_ugv_descriptions/urdf/panther/common/gazebo.urdf.xacro) file for details).
