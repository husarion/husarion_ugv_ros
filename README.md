...
| 🤖🖥️  | `robot_states_bt_project_path` | Path to BehaviorTree project file, responsible for robot states management. <br/> ***string:*** [`DockingBT.btproj`](./panther_manager/behavior_trees/DockingBT.btproj)                                                                                                                                                                   |
