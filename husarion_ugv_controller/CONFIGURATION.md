...
The heading correction feature is an experimental enhancement designed to help the robot maintain its angular velocity and heading angle more effectively. This improves the robot's overall control and stability. However, it should be used with caution, as it is still under development. To enable this feature, set the `heading_correction` launch argument to `true`.
