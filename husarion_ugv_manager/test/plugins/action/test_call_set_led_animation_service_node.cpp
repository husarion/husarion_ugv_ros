...
public:
  void ServiceCallback(
    const husarion_ugv_msg::srv::SetLEDAnimation::Request::SharedPtr request,
    husarion_ugv_msg::srv::SetLEDAnimation::Response::SharedPtr response, const bool success,
...
TEST_F(TestCallSetLedAnimationService, GoodSetLedAnimationCallServiceSuccessWithTrueRepeatingValue)
{
  ...
  using husarion_ugv_msg::srv::SetLEDAnimation;
